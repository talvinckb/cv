...
\begin{center}
  ...
  \parbox{17cm}{\centering Étudiant à EPITA (majeure Image), orienté \textbf{vision par ordinateur}
  et \textbf{IA}, basé en Île-de-France.}
\end{center}
...
\proj{Segmentation d'images avec U-Net}{U-Net (encodeur-décodeur, skip connections) implémenté \textbf{from scratch} en
...
\proj{Suivi de tumeurs cérébrales}{Recalage 3D d'IRM (rigide, affine, B-spline), segmentation de gliome
  et \textbf{quantification de l'évolution tumorale} (+61,8\,\% de volume), avec visualisation 3D.}
