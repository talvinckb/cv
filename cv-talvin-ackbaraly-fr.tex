...
\job{Développeur Full-Stack \& DevOps \textnormal{\color{soft}(stage)}}{\chip{Java}\chip{Spring Boot}\chip{Angular}\chip{AWS}}
    ...
    {Développement de fonctionnalités full-stack pour une plateforme interne de gestion des droits,
     contrats et catalogue, utilisée par \textbf{100+ collaborateurs}. Mise en place du pipeline CI/CD
...
\skillrow{Développement \& DevOps}{\chip{Spring Boot}\chip{Angular}\chip{React}\chip{Docker}\chip{GitLab CI}\chip{AWS}\chip{PostgreSQL}}
