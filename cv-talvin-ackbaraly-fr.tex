...
\job{Projet de fin d'études — Vision par ordinateur \textnormal{\color{soft}(équipe de 4)}}{mai 2026 -- en cours}
    ...
    {Détection (\textbf{YOLO26}) et classification hiérarchique (\textbf{ConvNeXt}) d'illustrations patrimoniales
     ...
     et exports structurés pour la validation humaine sur Label Studio. Benchmark de modèles, métriques définies
     avec le client.}
\vspace{10pt}
...
\projgap
\proj{Imagerie 3D}{équipe de 4}{Recalage 3D d'IRM cérébrales (rigide, affine, B-spline) et segmentation
  de gliome, \textbf{suivi de l'évolution tumorale} en vues 3D et multi-coupes.}
