...
\job{Projet de fin d'études — Vision par ordinateur \textnormal{\color{soft}(équipe de 4)}}{mai 2026 -- en cours}
    ...
    {Détection (\textbf{YOLO26}) et classification hiérarchique (\textbf{ConvNeXt}) d'illustrations patrimoniales
     dans les documents numérisés de Gallica, via l'API IIIF. Entraînement sur un \textbf{dataset de 10\,000 images}
     annotées par la BnF sur Label Studio (découpage train/val). Benchmark de modèles sur des métriques définies
     avec le client : détection à \textbf{94,7\,\%~de~mAP50} (85,2\,\% en mAP50-95) sur le jeu de validation.}
\vspace{10pt}
