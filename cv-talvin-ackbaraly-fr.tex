...
\begin{center}
  ...
  Élève ingénieur — Vision par ordinateur, calcul GPU \& ingénierie logicielle\\[5pt]
  {\small
  ...
  \parbox{17cm}{\centering Étudiant en dernière année à EPITA, majeure Image. Profil hybride :
  \textbf{vision par ordinateur} et \textbf{calcul GPU} côté recherche appliquée, ingénierie
  \textbf{full-stack} et DevOps côté production. Recherche un \textbf{stage de fin d'études de
  6 mois en vision par ordinateur ou IA} à partir de février 2027, en Île-de-France.}
\end{center}
...
\proj{Deep learning}{équipe de 4}{\textbf{Projet de fin d'études} pour la \textbf{Bibliothèque nationale
  de France} : détection et classification d'illustrations dans des documents numérisés. Benchmark de
  modèles sur \textbf{30\,Go}, métriques définies avec le client.}
...
\job{Développeur Full-Stack \textnormal{\color{soft}(freelance)}}{sept. 2026 -- en cours}
    ...
    {Conception et développement d'une application web de gestion de stock pour un client professionnel,
     \textbf{de bout en bout} : cahier des charges, maquettes et modélisation UML, développement full-stack,
     CI/CD et déploiement. Suivi de stock temps réel, gestion des rôles et identification par QR code.}
\vspace{6pt}
...
\vspace{6pt}
\job{Consultant en informatique \textnormal{\color{soft}(stage)}}{juin -- juil. 2023}
