...
\job{Projet de fin d'études — Vision par ordinateur \textnormal{\color{soft}(équipe de 4)}}{mai 2026 -- en cours}
    ...
    {Détection et classification hiérarchique d'illustrations patrimoniales de Gallica via l'API IIIF.
     \textbf{Silver dataset de 10\,000 images} validé sur Label Studio, benchmark de modèles sur \textbf{30\,Go},
     métriques définies avec le client.}
\vspace{6pt}
