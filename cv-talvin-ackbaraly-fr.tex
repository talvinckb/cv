...
\projectItem{PFEE}{Projet de fin d'études en partenariat avec la BNF : segmentation et classification d'illustrations extraites de documents numérisés. Benchmarks de modèles (YOLO, Florence-2), définition des métriques, suivi client hebdomadaire. \textit{(équipe de 4)}}{\cvtag{Deep Learning} \cvtag{YOLO} \cvtag{Gestion de projet}}
