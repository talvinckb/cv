...
\begin{center}
  ...
  \parbox{17cm}{\centering Étudiant en dernière année à EPITA, majeure Image, orienté \textbf{vision par ordinateur}
  et \textbf{IA}, avec une ouverture vers le \textbf{calcul GPU}. Basé en Île-de-France.}
\end{center}
...
\job{Projet de fin d'études — Vision par ordinateur \textnormal{\color{soft}(équipe de 4)}}{mai 2026 -- en cours}
    ...
    {Détection (\textbf{YOLO26}) et classification hiérarchique (\textbf{ConvNeXt}) d'illustrations patrimoniales
     dans les documents numérisés de Gallica, via l'API IIIF. \textbf{En charge de la détection} : entraînement sur
     un \textbf{dataset de 10\,000 images} annotées par la BnF sur Label Studio, benchmark de
     modèles, paramètres et prétraitements selon les métriques du client, pour \textbf{94,7\,\%~de~mAP50}
...
\projgap
\proj{Suivi de tumeurs cérébrales}{Recalage 3D d'IRM (rigide, affine, B-spline), segmentation de gliome et
  \textbf{quantification de l'évolution tumorale} (+61,8\,\% de volume).}
