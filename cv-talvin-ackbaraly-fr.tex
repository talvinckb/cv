...
\begin{minipage}[c]{\dimexpr\textwidth-\photosize-0.3cm\relax}
  ...
  Étudiant en dernière année à EPITA, majeure Image, orienté vision par ordinateur
  et IA, avec une ouverture vers le calcul GPU. Basé en Île-de-France.
\end{minipage}\hfill
...
\proj{Suivi de tumeurs cérébrales}{Recalage 3D d'IRM (rigide, affine, B-spline), segmentation de gliome et
  quantification de l'évolution tumorale (+61,8\,\% de volume).}
