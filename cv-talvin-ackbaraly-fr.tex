...
\edu{EPITA — École d'ingénieurs en informatique}{sept. 2022 -- 2027}
...
\job{Consultant en informatique \textnormal{\color{soft}(stage)}}{\chip{Python}\chip{Django}\chip{Agile SAFe}}
    ...
    {Prototype d'application de gestion fournisseurs, produits et contrats pour Sonepar, \textbf{plus grand client de Hitachi Solutions}.}
