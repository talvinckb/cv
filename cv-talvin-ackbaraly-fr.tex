...
\job{Développeur Full-Stack \textnormal{\color{soft}(freelance)}}{\chip{Conception}\chip{Architecture}\chip{Full-Stack}\chip{Déploiement}}
    {Auto-entrepreneur}{depuis 2026 · en cours}
    {Application de \textbf{gestion des stocks} pour un client professionnel, de bout en bout : cahier des
     charges, maquettes et modélisation UML, développement (Next.js, NestJS, PostgreSQL), CI/CD et mise en production.}
\vspace{6pt}
...
\job{Consultant en informatique \textnormal{\color{soft}(stage)}}{\chip{Python}\chip{Django}\chip{Agile SAFe}}
    ...
    {Prototype d'application de gestion fournisseurs, produits et contrats pour le client Sonepar.}
