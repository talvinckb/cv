...
\begin{center}
  ...
  \parbox{17cm}{\centering Final-year engineering student at EPITA, Image specialization, focused on
  \textbf{computer vision} and \textbf{AI}, with an interest in \textbf{GPU computing}. Based in the Paris area.}
\end{center}
...
\job{Final-Year Project — Computer Vision \textnormal{\color{soft}(team of 4)}}{May 2026 -- ongoing}
    ...
    {Detection (\textbf{YOLO26}) and hierarchical classification (\textbf{ConvNeXt}) of heritage illustrations in
     Gallica's digitized documents, via the IIIF API. \textbf{In charge of detection}: training on a
     \textbf{10,000-image dataset} annotated by the BnF in Label Studio, benchmarking models,
     parameters and preprocessing on the client's metrics, reaching \textbf{94.7\%~mAP50} (85.2\% mAP50-95)
...
\proj{Brain tumor tracking}{3D registration of brain MRI scans (rigid, affine, B-spline), glioma
  segmentation and \textbf{quantified tumor progression} (+61.8\% in volume).}
