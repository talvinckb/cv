...
\job{Final-Year Project — Computer Vision \textnormal{\color{soft}(team of 4)}}{May 2026 -- ongoing}
    ...
    {Detection (\textbf{YOLO26}) and hierarchical classification (\textbf{ConvNeXt}) of heritage illustrations in
     Gallica's digitized documents, retrieved through the IIIF API. Built a \textbf{10,000-image silver dataset}
     with structured exports for human validation in Label Studio. Benchmarked models, with evaluation
     metrics defined with the client.}
\vspace{10pt}
...
\projgap
\proj{3D imaging}{team of 4}{3D registration of brain MRI scans (rigid, affine, B-spline) and glioma
  segmentation, \textbf{tracking tumor growth} in 3D and multi-slice views.}
