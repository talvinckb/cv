...
\begin{minipage}[c]{\dimexpr\textwidth-\photosize-0.3cm\relax}
  ...
  computer vision and AI, with an interest in GPU computing. Based in the Paris area.
\end{minipage}\hfill
...
\job{Full-Stack Developer \textnormal{\color{soft}(freelance)}}{Sept. 2026 -- ongoing}
    ...
    {Launched a freelance web development business. Ongoing engagement: an inventory management web app
     for a business client, handled end to end, from requirements specification (mockups, UML modelling)
