...
\definecolor{accent}{HTML}{1F3D5C}  % THE accent: name, sections, links, bullets
...
\setlist[itemize]{leftmargin=1.1em, label={\color{accent!55}\textbullet}, topsep=2pt, itemsep=1.5pt, parsep=0pt}
