...
\begin{center}
  ...
  Engineering student — Computer Vision, GPU Computing \& Software Engineering\\[5pt]
  {\small
  ...
  profile: \textbf{computer vision} and \textbf{GPU computing} on the applied-research side,
  \textbf{full-stack} and DevOps engineering on the production side. Seeking a \textbf{6-month
  final-year internship in computer vision or AI} starting February 2027, in the Paris area.}
\end{center}
...
\proj{Deep learning}{team of 4}{\textbf{Final-year project} for the \textbf{National Library of France}:
  detecting and classifying illustrations in digitized documents. Benchmarked models on
