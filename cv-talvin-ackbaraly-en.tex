...
\begin{center}
  ...
  Final-year internship — Computer Vision \& AI · 6 months from February 2027\\[5pt]
  {\small
  ...
  \parbox{17cm}{\centering Final-year engineering student at EPITA, Image specialization. Hybrid
  profile: \textbf{computer vision}, \textbf{AI} and \textbf{GPU computing} on the applied-research side,
  \textbf{full-stack} and DevOps engineering on the production side. Based in the Paris area.}
\end{center}
...
\job{Final-Year Project — Computer Vision \textnormal{\color{soft}(team of 4)}}{May 2026 -- ongoing}
    ...
    {Detection and hierarchical classification of heritage illustrations from Gallica via the IIIF API.
     Built a \textbf{10,000-image silver dataset} validated in Label Studio, benchmarked models on \textbf{30\,GB},
     with metrics defined with the client.}
\vspace{6pt}
\job{Full-Stack Developer \textnormal{\color{soft}(freelance)}}{Sept. 2026 -- ongoing}
    ...
    {Design and development of a web-based inventory management application for a business client,
     \textbf{end to end}: requirements specification, mockups and UML modelling, full-stack development,
     CI/CD and deployment. Real-time stock tracking, role-based permissions and QR-code identification.}
\vspace{6pt}
...
\job{IT Consultant \textnormal{\color{soft}(internship)}}{June -- July 2023}
    {Hitachi Solutions France}{\chip{Python}\chip{Django}\chip{Agile SAFe}}
